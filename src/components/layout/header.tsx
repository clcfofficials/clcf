                    ...
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full justify-between lg:w-auto">
                             <Link href="/" className="flex items-center space-x-2">
                                <Image src="https://i.ibb.co/8DPGfb59/Logo-page-0001-removebg-preview.png" alt="Crop Life Care Fertilizers Logo" width={40} height={40} className="h-10 w-auto dark:hidden" />
                                <Image src="/mainLogoDark.png" alt="Crop Life Care Fertilizers Logo" width={40} height={40} className="h-10 w-auto hidden dark:block" />
